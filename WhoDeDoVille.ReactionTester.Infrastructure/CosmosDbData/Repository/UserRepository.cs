...
public class UserRepository : CosmosDbRepository<User>, IUserRepository
{
    ...
    public async Task<IEnumerable<User>> GetItemsAsyncByEmail(string email)
    {
        ...
        IEnumerable<User> entities = await GetItemsAsync(queryString);
    ...
    /// </summary>
    /// <returns>User Container Properties</returns>
    ...
    private IndexingPolicy IndexingPolicy { get; } = new IndexingPolicy()
    {
